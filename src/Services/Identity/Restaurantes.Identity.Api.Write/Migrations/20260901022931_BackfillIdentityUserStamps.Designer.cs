...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Restaurantes.Identity.Api.Write.ApplicationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Restaurantes.Identity.Api.Write.UserRestaurantAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("Restaurantes.Identity.Api.Write.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Restaurantes.Identity.Api.Write.UserRestaurantAssignment", b =>
                {
                    b.HasOne("Restaurantes.Identity.Api.Write.ApplicationUser", "User")
